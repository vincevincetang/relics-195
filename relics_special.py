...
relics_special = [
  ...
  },
  {
    ...
    "owner": "黄裳（原绘）·王致远（摹刻）",
    "source": "南宋绍熙年间（1190-1194年）黄裳绘制《天文图》原稿，作为'王者之学'献给太子赵扩（即宋宁宗），史称'绍熙八图'。淳祐七年（1247年），王致远从蜀地得图稿，摹刻上石立于苏州府学。1961年与《平江图》《地理图》《帝王绍运图》同列首批全国重点文物保护单位。",
  ...
  },
  {
    ...
    "era": "南宋绍定二年（1229年）刻制",
    "owner": "李寿朋（主持刻制）",
    "source": "南宋绍定二年（1229年）平江知府李寿朋主持摹刻上石，置于苏州府学。碑面以平面与立体结合技法绘制，碑首雕交龙图案，正中刻'平江图'三字，1917年曾加以深刻。1961年与《天文图》《地理图》《帝王绍运图》同列首批全国重点文物保护单位。",
