...
relics_special = [
  ...
  },
  {
    ...
    "owner": "东晋·王羲之（书圣）",
    "no": 5,
    "source": "原帖为王羲之致友人信札。唐代即入宫廷收藏，乾隆帝将其与王献之《中秋帖》、王珣《伯远帖》合称三希，藏于养心殿三希堂。1949年运至台北。",
  ...
  },
  {
    ...
    "desc": "居延里程简记载长安至张掖郡间20个驿置名称及间隔里程。悬泉里程简记载武威郡仓松至敦煌郡渊泉间12个驿置里程。两简接力勾勒出长安至敦煌的汉代丝绸之路东段完整路线，为丝路申遗成功提供了决定性物证。",
    "museum": "甘肃简牍博物馆",
  ...
  },
  {
    ...
    "desc": "高4.3厘米，口径6.8厘米，足径2.6厘米。胎薄如纸，透光可见指纹。杯身绘三秋花卉与蝴蝶，青花勾勒轮廓，釉上填红、黄、绿诸彩。其中紫色饰片为成化独有的姹紫彩，表面无光，后世无法仿制，是鉴定成化斗彩的关键特征。",
    "museum": "故宫博物院",
  ...
  },
  {
    ...
    "desc": "直径约4.8厘米，银质鎏金，镂空錾刻葡萄花鸟缠枝纹。内置持平环（陀螺仪原理），无论球体如何转动，内层香盂始终朝上，香料不会洒落。集捶揲、錾刻、焊接、镂空于一身，是唐代金银器工艺与古代工程智慧的巅峰之作。",
    "museum": "陕西历史博物馆",
  ...
  },
  {
    ...
    "period": "战国",
    "owner": "战国早期曾国国君曾侯乙",
    "source": "1978年湖北随县（今随州市）擂鼓墩曾侯乙墓出土。",
    "desc": "高63.2厘米，口径63.4厘米。方尊缶置于方鉴正中，鉴腹与尊缶之间可置冰。方鉴四足和四耳饰以龙形雕刻。世界上最早的冰镇容器，比西方同类技术早一千余年，为古代制冷技术的重要物证。",
    "museum": "中国国家博物馆",
  ...
  },
  {
    ...
    "era": "五代·约924年",
    "period": "五代",
    "owner": "五代义武军节度使王处直（墓主）",
    "source": "1994年河北省曲阳县王处直墓被盗，此浮雕连同其它浮雕被贩卖到香港后走私至美国。2000年被美国海关查获，2001年经美国法院判决归还中国，为美国首次通过司法程序归还中国文物。",
    "desc": "高约113厘米，宽约58厘米，汉白玉彩绘浮雕。武士身穿铠甲，脚踏卧鹿，头戴凤盔，肩生火焰。雕刻精细，色彩艳丽，造型威猛又不失灵动。是五代时期大型彩绘石刻浮雕的孤例，填补了唐宋之间雕塑史的空白。",
    "museum": "中国国家博物馆",
  ...
  },
  {
    ...
    "period": "唐",
    "owner": "唐·李白（诗人）",
    "source": "李白唯一存世墨迹。流传有序，宋代入宣和内府，元明清经名家递藏，清末流出宫外。1949年后入藏故宫博物院。",
    "desc": "纵28.5厘米，横38.1厘米，纸本草书。全文25字：山高水长，物象千万，非有老笔，清壮何穷。为李白与杜甫、高适同游王屋山阳台观时所作。宋徽宗题签，历代鉴藏家著录清晰。诗仙唯一存世笔迹。",
    "museum": "故宫博物院",
  ...
  },
  {
    ...
    "period": "唐",
    "owner": "唐代宫廷工匠",
    "source": "唐宫廷赠予日本的国礼，为日本圣武天皇遗爱品。现藏日本奈良正仓院，每年仅在秋季特展中短暂展出。",
    "desc": "全长108.5厘米，紫檀木制，五弦直项。通体以螺钿镶嵌牡丹、鸳鸯、飞鸟等纹样，背面嵌以美丽的花纹，耗材极奢。五弦琵琶形制在中原早已失传，此件为全球唯一存世的唐代五弦琵琶实物，是研究唐代乐器与髹漆工艺的绝品。",
    "museum": "日本奈良正仓院",
  ...
  },
  {
    ...
    "era": "明·万历三十年（1602年）",
    "period": "明",
    "owner": "明·利玛窦（意大利传教士、绘制）、李之藻（刊刻）",
    "source": "1602年由利玛窦与李之藻合作绘制刊刻于北京。现存6件，分藏梵蒂冈、日本、美国等。南京博物院藏有一件彩色摹绘本，为民国时期从日本购回，是中国大陆仅存的公藏版本之一。",
    "desc": "通幅纵168厘米，横380厘米，木刻墨印设色。以中国为中心绘出五大洲及四大洋，标注了美洲、南极等地理概念。为中国最早引进欧洲地理大发现成果的世界地图，是东西方知识交汇的里程碑。",
    "museum": "南京博物院",
  ...
  },
  {
    ...
    "period": "战国",
    "owner": "秦国王室（调兵凭证左半）",
    "source": "1975年陕西省西安市南郊出土。",
    "desc": "长9.5厘米，高4.4厘米，厚0.7厘米。青铜铸成虎形，昂首卷尾，作行走状。通体错金铭文40字：兵甲之符，右在君，左在杜。是秦国调兵遣将的信物凭证。虎符制度是中国古代军事加密认证的起源，符合一词即由此而来。",
    "museum": "陕西历史博物馆",
  ...
  },
  {
    ...
    "period": "清",
    "owner": "清高宗·乾隆皇帝（下令雕造）",
    "source": "乾隆皇帝为彰显功绩并效法先王而命造办处雕造，以太湖石为蓝本设计构图。清宫旧藏，现藏故宫博物院。",
    "desc": "高224厘米，宽96厘米，重约5.3吨，以新疆和田青玉雕成。描绘大禹率众开山治水的壮阔场景，峰峦叠嶂、人物众多。从采玉到完工历时十年，是中国乃至世界最大的玉雕作品，清代玉器工艺的巅峰。",
    "museum": "故宫博物院",
  ...
  },
  {
    ...
    "era": "战国·楚·约前323年",
    "period": "战国",
    "owner": "楚国王室（赐予鄂君启的通行凭证）",
    "source": "1957年安徽省寿县出土。现存5件（舟节2、车节3），分藏中国国家博物馆和安徽省博物院。",
    "desc": "青铜铸成竹节形，通体错金铭文。舟节记载水路通行路线及船只限额，车节记载陆路通行路线及车马限额，详列关口、免税范围及违禁处罚。是研究楚国商业税法、交通制度和经济地理的珍贵实物，也是先秦最长的商业法令铭文。",
  ...
  },
  {
    ...
    "period": "五代",
    "owner": "五代义武军节度使王处直（墓主）",
    "source": "1994年河北省曲阳县王处直墓被盗。此浮雕已被追回。",
    "desc": "汉白玉彩绘浮雕，长约1.2米，高约0.6米。浮雕由十二名女乐伎组成，演奏箜篌、琵琶、拍板、筚篥、笙、笛、羯鼓、腰鼓、筝等乐器，前有一人起舞。人物体态婀娜，衣带飘扬，是研究五代音乐史、乐器制度和服饰的珍贵实物。",
    "museum": "中国国家博物馆",
  ...
  },
  {
    ...
    "era": "西周·约前10-前9世纪",
    "period": "西周",
    "owner": "西周邓国贵族女子邓仲（陪嫁器）",
    "source": "陕西省长安县张家坡西周墓出土。为邓国女子嫁入周王畿的陪嫁品。",
    "desc": "青铜酒尊，通高38.8厘米，通长41.4厘米。器型为复合神兽造型，似马非马、头生双角、腹有双翼，集合多种动物特征，通体三层纹饰。盖器同铭邓仲作宝尊彝6字。是西周跨区域联姻制度的实物见证，也是西周动物形青铜尊的代表作。",
    "museum": "中国考古博物馆",
  ...
  },
  {
    ...
    "period": "唐",
    "owner": "唐·武则天（女皇）",
    "source": "1982年河南省登封县嵩山峻极峰发现。农民采药时拾得后上交。",
    "desc": "黄金质，长36.2厘米，宽8厘米，重223.5克。正面镌刻63字，记述武则天遣道士胡超向三官九府投简祈福除罪之事，内含武则天自创新字。是中国唯一女皇的唯一存世遗物，也是研究唐代道教投龙仪式的珍贵实物。",
    "museum": "河南博物院",
  ...
  },
  {
    ...
    "period": "五代",
    "owner": "吴越国王·钱俶（下令铸造）",
    "source": "2001年浙江省杭州市雷峰塔地宫出土。为吴越王钱俶效仿阿育王造八万四千塔故事所铸。",
    "desc": "银质鎏金，通高约36厘米。塔身方形，四面各刻佛本生故事，塔刹饰五重相轮。造型精美，工艺繁复，是吴越国崇佛的实物见证，也是雷峰塔地宫最重要的出土文物之一。",
    "museum": "浙江省博物馆",
  ...
  },
  {
    ...
    "era": "明·洪武年间（约14世纪末）",
    "period": "明",
    "owner": "明鲁荒王·朱檀（明太祖朱元璋第十子）",
    "source": "1971年山东省邹城市鲁荒王朱檀墓出土。",
    "desc": "竹胎髹黑漆，冠顶置金饰，前后各悬九旒，每旒贯赤、白、青、黄、黑五色玉珠九颗。为明代亲王举行大典时所戴礼冠，是现存唯一的明代冕旒实物，对研究明代冠服制度具有不可替代的价值。",
    "museum": "山东博物馆",
  ...
  },
  {
    ...
    "period": "商",
    "owner": "商代亚丑族（方国或部族首领）",
    "source": "1965年山东省青州市苏埠屯商墓出土。",
    "desc": "青铜质，通长32.7厘米，刃宽34.5厘米。钺身透雕作张口露齿的人面形，双目圆睁，表情似笑非笑，造型狞厉而富神秘感，是商代青铜钺中最为独特的一件。亚丑为其族徽铭文。",
    "museum": "山东博物馆",
  ...
  },
  {
    ...
    "owner": "南宋·沈子蕃（缂丝工艺家）",
    "source": "清宫旧藏。现藏故宫博物院。",
    "desc": "缂丝，纵104厘米，横36厘米。以通经断纬技法织出梅枝横斜、双鹊栖止之景，工致细腻，配色古雅。沈子蕃为南宋最负盛名的缂丝名家，此作是其传世代表作，代表了中国古代缂丝工艺的极高水平。",
    "museum": "故宫博物院",
  ...
  },
  {
    ...
    "period": "战国",
    "owner": "战国巴蜀地区贵族（墓主）",
    "source": "1965年四川省成都市百花潭中学战国墓出土。",
    "desc": "青铜质，高40.3厘米，腹径26.5厘米。器身以金银错工艺分四层装饰：采桑习射、宴乐战舞、水陆攻战、狩猎场景，共刻画两百余人。纹饰从神秘主题转向现实题材，是研究战国军事、社会的重要视觉史料。",
    "museum": "四川博物院",
  ...
  },
  {
    ...
    "period": "商",
    "owner": "商代淮夷部族首领",
    "source": "1957年安徽省阜南县润河段淮河中被渔民捞获。同出另有饕餮纹尊一件。",
    "desc": "青铜质，高50.5厘米，口径44.7厘米。大敞口，鼓腹，圈足。肩部饰三条立体龙首，腹部主体为三组虎噬人纹，猛虎张口欲噬、人形屈臂。经考古证实为淮夷地方铸造，证明淮河流域已掌握媲美中原的青铜铸造技术。",
    "museum": "中国国家博物馆",
  ...
  },
  {
    ...
    "period": "南宋",
    "owner": "宋代宫廷或文人（仿古陈设）",
    "source": "清宫旧藏。乾隆帝定名为旧玉飞龙彝炉，并镌刻御制诗于器底。",
    "desc": "青玉质，高7.9厘米，口径12.8厘米。形制仿青铜簋，腹饰云龙纹，两侧有兽首衔环耳。是宋代仿古玉器的典范之作，列入故宫博物院十件镇院之宝之一。底部刻乾隆御题诗，见证了宋至清跨代鉴赏的深度。",
    "museum": "故宫博物院",
  ...
  },
  {
    ...
    "period": "清",
    "owner": "清高宗·乾隆皇帝（御用）",
    "source": "清宫造办处制作，清代皇帝每年元旦举行开笔仪式时专用。清宫旧藏，现存四件。",
    "desc": "黄金质，镶嵌珍珠、宝石。杯身錾刻缠枝宝相花纹，口沿铸篆书金瓯永固四字。为乾隆皇帝钦定的元旦开笔仪礼器，每年正月初一子时，皇帝以此杯饮屠苏酒，亲笔御书祈求国泰民安。是清代宫廷礼制的重要实物见证。",
    "museum": "故宫博物院",
  ...
  },
  {
    ...
    "period": "南宋",
    "owner": "南宋·辛弃疾（词人、将领）",
    "source": "辛弃疾传世唯一墨迹。清宫旧藏。",
    "desc": "纸本行书，纵30.5厘米，横96厘米。书文35行，内容为辛弃疾致友人书信。辛弃疾为南宋最杰出的词人，此帖是其存世唯一的亲笔书迹，与苏轼寒食帖共同构成了宋代文人墨迹的双璧。",
    "museum": "故宫博物院",
  ...
  },
  {
    ...
    "period": "南宋",
    "owner": "宋代龙泉窑（烧制）",
    "source": "1991年四川省遂宁市金鱼村窖藏出土。出土时罐内装有99件小瓷碟，为窖藏中最大的一件。",
    "desc": "龙泉窑梅子青釉，通高31.3厘米，口径23.8厘米。盖作荷叶卷曲状，器身施梅子青釉，釉色碧绿如翡翠。是南宋龙泉青瓷的标准器，国家一级文物，四川宋瓷博物馆镇馆之宝。",
    "museum": "四川宋瓷博物馆（遂宁）",
  ...
  },
  {
    ...
    "owner": "宋代定窑（烧制）",
    "source": "清宫旧藏。",
    "desc": "定窑白瓷，高18.3厘米，长30厘米。以孩童俯卧造型为枕面，婴儿神态安详，手足生动。胎质细腻，釉色牙白温润。是宋代定窑人物雕塑与实用器结合的代表作，宋代五大名窑中定窑的最知名器物。",
    "museum": "故宫博物院",
  ...
  },
  {
    ...
    "period": "唐",
    "owner": "唐代雷氏家族（斫琴世家）",
    "source": "传为盛唐雷氏所斫。历经宋、元、明、清名家递藏，1952年由国家文物局从刘晦之处购藏入故宫。",
    "desc": "伏羲式，通长124.5厘米。盛唐雷威一脉所斫。琴足刻苏轼诗「霭霭春风细，琅琅环佩音。垂帘新燕语，沧海虎龙吟」。龙池右侧刻黄庭坚「超迹苍霄，逍遥太极」。为传世五张九霄环佩中唯一有苏黄手迹者。",
    "museum": "故宫博物院",
  ...
  },
  {
    ...
    "period": "战国",
    "owner": "战国匈奴王（酋长）",
    "source": "1972年内蒙古杭锦旗阿鲁柴登匈奴墓出土。同出金银器200余件，为最重要的匈奴考古发现之一。",
    "desc": "黄金质，重1394克。冠顶立鹰，首颈以绿松石嵌接，可左右摆动。冠面浮雕狼咬羊场景，冠带饰卧虎、卧马、盘角羊。全国唯一完整匈奴王金冠，赵武灵王胡服骑射之胡冠即此形制。",
    "museum": "内蒙古博物院",
  ...
  },
  {
    ...
    "period": "北宋",
    "owner": "黄庭坚",
    "source": "清末经鄂督张之洞进呈入藏清内府，后辗转至台北故宫博物院。",
    "desc": "纵32.8厘米，横219.2厘米，纸本行书29行153字。黄庭坚崇宁元年夜宿武昌西山松风阁，自书七言古诗，后半段追念苏轼，笔力苍劲沉雄，结体中宫紧收而长笔四展，为典型'山谷体'扛鼎之作。与《寒食帖》《苕溪诗帖》并称宋人行书三绝。",
    "museum": "台北故宫博物院",
  ...
  },
  {
    ...
    "period": "北宋",
    "owner": "米芾",
    "source": "明清经项元汴、董其昌、清内府等递藏，现藏于台北故宫博物院。",
    "desc": "纵27.8厘米，横270厘米，乌丝栏绢本行书71行658字。米芾38岁时应湖州郡守林希之邀，于珍藏44年之珍品蜀素上挥毫，自书《拟古》《吴江垂虹亭作》等八首。笔法八面出锋、刷字凌厉，结体欹侧生姿而气脉贯通，为'尚意'书风巅峰之作。",
    "museum": "台北故宫博物院",
  ...
  {
    "name": "南宋《天文图》碑",
    "era": "南宋淳祐七年（1247年）摹刻上石",
    "period": "南宋",
    "owner": "黄裳（原绘）·王致远（摹刻）",
    "source": "南宋绍熙年间（1190-1194年）黄裳绘制《天文图》原稿，作为'王者之学'献给太子赵扩（即宋宁宗），史称'绍熙八图'。淳祐七年（1247年），王致远从蜀地得图稿，摹刻上石立于苏州府学。",
    "desc": "纵2.16米横1.08米青石质。上刻全天星图1434颗二十八宿分区，下刻约2100字解说十四天文学概念。南宋黄裳原绘，王致远1247年摹刻上石。与《平江图》并称四大宋碑首批国保。世界最早石刻天文实测星图。",
    "museum": "苏州碑刻博物馆（苏州文庙）",
  ...
  },
  {
    ...
    "period": "南宋",
    "owner": "李寿朋（主持刻制）",
    "source": "南宋绍定二年（1229年）平江知府李寿朋主持摹刻上石，置于苏州府学。碑面以平面与立体结合技法绘制，碑首雕交龙图案，正中刻'平江图'三字，1917年曾加以深刻。",
    "desc": "纵2.9米横1.49米青石质。碑刻南宋平江城全貌，五水陆城门六百余处地名，双棋盘格局记20河道82公里20街道359座桥。绍定二年（1229年）知府李寿朋刻制。与《天文图》并列四大宋碑首批国保。世界最早石刻城市实测地图。",
    "museum": "苏州碑刻博物馆（苏州文庙）",
  ...
  },
  {
    ...
    "period": "西汉",
    "owner": "汉武帝（赐予阳信长公主）",
    "source": "1981年陕西省兴平市茂陵东侧从葬坑出土。未央宫御制器，炉口铭文载其为未央宫旧物，后被汉武帝赐予阳信长公主（即平阳公主，汉武帝姊）与大将军卫青，可视为二人婚仪赏器。",
  ...
  },
  {
    ...
    "era": "隋大业四年（608年）",
    "period": "隋",
    "owner": "李静训（外祖母为隋文帝长女杨丽华）",
    "source": "1957年陕西省西安市西郊梁家庄李静训墓出土。墓主李静训（字小孩）为隋文帝外孙女，外祖母为乐平公主杨丽华，9岁夭折，厚葬于皇城内。石棺刻'开者即死'四字铭文。",
    "desc": "长11.47厘米宽8.3厘米。金片托两端上卷荷叶。上插六瓣金花三角金荷叶珍珠，花蕊嵌珍珠宝石，金丝编网串珠垂饰，花瓣顶立金丝嵌珍珠飞蛾作闹蛾扑花状。是中国考古发掘出土的最早的闹蛾实物。",
    "museum": "中国国家博物馆",
  ...
  {
    "name": "王子午鼎",
    "era": "春秋晚期·楚康王时期（约前558-前552年）",
    "period": "春秋",
    "source": "1978年河南省淅川县下寺楚墓2号墓出土。同出共七件列鼎一组，为楚庄王之子、令尹王子午（子庚）所作祭祀礼器。",
    "owner": "王子午（楚庄王之子，字子庚）",
    "desc": "通高76厘米，口径66厘米，重100.2公斤。侈口束腰鼓腹，典型楚式升鼎。腹壁六条失蜡法铸立体夔龙攀附，鼎足与底部采用冷焊工艺，为当时世界一流铸造水平。内壁铸84字鸟虫书铭文，记王子午施德政铸鼎事，最早美术字长铭。",
    "museum": "中国国家博物馆（最大一件）/ 河南博物院",
    "image_url": "https://www.chnmuseum.cn/zp/zpml/kgfjp/202108/P020220810593604627003.jpg",
    "baike_url": "https://baike.baidu.com/item/王子午鼎/4516127",
    "no": 108,
    "category": ["青铜器"],
    "period_order": 14,
  },
  {
    "name": "秦公镈",
    "era": "春秋早期·秦武公时期（约前697-前678年）",
    "period": "春秋",
    "source": "1978年陕西省宝鸡县（今陈仓区）太公庙窖藏出土。共三件，与秦公钟五件同出，原为九件编钟组合。",
    "owner": "秦武公",
    "desc": "通高75.1厘米，重62.5公斤。鼓部四道扉棱饰蟠龙飞龙凤鸟，全器共56条龙纹。器身铸135字铭文，记秦襄公受封及文公、静公、宪公至武公五代世系，为秦国早期历史与青铜铸冶技术的重要实证。铭文舒展遒婉，为大篆之上佳作品。",
    "museum": "宝鸡青铜器博物院",
    "image_url": "https://bkimg.cdn.bcebos.com/pic/b151f8198618367adab408619c2a9cd4b31c87014f4f",
    "baike_url": "https://baike.baidu.com/item/秦公镈/285831",
    "no": 109,
    "category": ["青铜器"],
    "period_order": 14,
  },
  {
    ...
    "era": "战国早期·约前433年",
    "period": "战国",
    "source": "1978年湖北省随州市擂鼓墩曾侯乙墓出土。出土时浮于西室水面，保存完好。同墓随葬大量漆木器。",
    "owner": "曾侯乙",
    "desc": "71×47×40.5厘米。木胎漆器，内髹红漆外髹黑漆。盖面朱绘青龙白虎北斗二十八宿图，正中书篆文斗字环绕二十八宿名。题甲寅三日，反映前433年初三天象。1978年曾侯乙墓出土。最早完整二十八宿天文实物，文献记录由秦末提至战国早期。",
    "museum": "湖北省博物馆",
    "image_url": "https://bkimg.cdn.bcebos.com/pic/e7cd7b899e510fb3aba77980de33c895d1430c6e",
    "baike_url": "https://baike.baidu.com/item/%E4%B8%9C%E5%91%A8%E5%BD%A9%E6%BC%86%E4%BA%8C%E5%8D%81%E5%85%AB%E5%AE%BF%E5%9B%BE%E8%A1%A3%E7%AE%B1/19236593",
    "no": 110,
    "category": ["漆器", "天文舆图"],
    "period_order": 15,
  },
  {
    ...
    "era": "元·至正十一年（1351年）",
    "period": "元",
    "owner": "元·信州路玉山县奉圣弟子张文进（定烧供奉）",
    "source": "瓶颈部楷书题记显示，元至正十一年信州路玉山县张文进喜舍香炉花瓶一副供奉星源祖殿。民国初年流出海外，为大维德基金会收藏。",
    "desc": "高63.6厘米，一对。喇叭口、象耳、瓶身绘云龙戏珠、缠枝莲、蕉叶等纹饰。颈部楷书题记15行61字（至正十一年），为元青花断代提供绝对纪年标尺，是至正型元青花的标准器，改写了中国陶瓷史。",
    "museum": "大英博物馆（英国伦敦）",
    "image_url": "https://bkimg.cdn.bcebos.com/pic/79f0f736afc37931930ce191e5c4b74543a91125",
    "baike_url": "https://baike.baidu.com/item/%E9%9D%92%E8%8A%B1%E4%BA%91%E9%BE%99%E7%BA%B9%E8%B1%A1%E8%80%B3%E7%93%B6/5959249",
    "no": 111,
    "category": ["瓷器"],
    "period_order": 32,
  },
  {
    ...
    "period": "战国",
    "owner": "战国楚地巫史（作者不详）",
    "source": "1942年湖南长沙子弹库楚墓盗掘出土。1946年被美国人柯强骗取至美国，1960年代由赛克勒购藏，后存赛克勒美术馆。第二、三卷2025年由史密森尼国立亚洲艺术博物馆返还中国。",
    "desc": "分《四时令》《五行令》《攻守占》三卷共900余字，图文并茂。四周彩绘12个神像各附月名注文，内容涉及天象历法、四时月令、神灵禁忌，是目前出土的唯一战国帛书，也是最早典籍意义上的古书。",
    "museum": "美国赛克勒基金会/ 湖南博物院",
    "image_url": "https://q0.itc.cn/q_70/images03/20240911/3835c78725be49e89e954c50eac4a195.png",
    "baike_url": "https://baike.baidu.com/item/%E6%A5%9A%E5%B8%9B%E4%B9%A6/3747330",
    "no": 112,
    "category": ["古籍简牍"],
    "period_order": 15,
  },
  {
    ...
    "era": "元·元贞元年（1295年）",
    "period": "元",
    "source": "赵孟頫为好友周密（号草窗）所作，述济南风物。传世经周密、文徵明、项元汴、纳兰性德、梁清标等递藏。清乾隆时入内府，1949年随文物南迁至台北。",
    "owner": "元·赵孟頫（书法家、画家）",
    "desc": "纵28.4厘米，横90.2厘米，纸本水墨设色。绘济南鹊山与华不注山秋景，平远构图，笔法潇洒古拙。以披麻皴、荷叶皴画山，水墨青绿相融，设色清丽淡雅。元代文人画转型的标志，上承晋唐古意、下启元四家，被后世推为赵孟頫一生得意笔。",
    "museum": "台北故宫博物院",
    "image_url": "https://bkimg.cdn.bcebos.com/pic/34fae6cd7b899e51a0be25424ea7d933c8950db7",
    "baike_url": "https://baike.baidu.com/item/%E9%B9%8A%E5%8D%8E%E7%A7%8B%E8%89%B2%E5%9B%BE/1179424",
    "no": 113,
    "category": ["绘画"],
    "period_order": 32,
  }
